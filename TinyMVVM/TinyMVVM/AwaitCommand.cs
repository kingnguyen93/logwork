...
namespace TinyMVVM
{
    ...
    public class AwaitCommand : ICommand
    {
        ...
        /// </summary>
        /// <param name="execute">Execute.</param>
        public AwaitCommand(Action<object, TaskCompletionSource<bool>> execute)
        {
        ...
        /// </summary>
        /// <param name="execute">Execute.</param>
        public AwaitCommand(Action<TaskCompletionSource<bool>> execute) : this((o, tcs) => execute(tcs))
        {
            if (execute == null)
            {
                throw new ArgumentNullException(nameof(execute));
        ...
        /// </summary>
        /// <param name="execute">Execute.</param>
        public AwaitCommand(Action<object, TaskCompletionSource<bool>> execute, Func<object, bool> canExecute) : this(execute)
        {
        ...
        /// </summary>
        /// <param name="execute">Execute.</param>
        public AwaitCommand(Action<TaskCompletionSource<bool>> execute, Func<bool> canExecute) : this((o, tcs) => execute(tcs), o => canExecute())
        {
            if (execute == null)
            {
                throw new ArgumentNullException(nameof(execute));
